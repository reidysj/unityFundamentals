...
public class MouseManager : MonoBehaviour
{
    ...
    public Texture2D pointer; // standard cursor
    public Texture2D target; // cursor for clickables
    public Texture2D doorway; // doorway cursor
    public Texture2D combat; // combat cursor
